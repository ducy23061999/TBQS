...
export default function ({onPressSave, onPressDiscard, onPressShare}) {
    const MyIcon = () => {
        return (
    ...
    return (
        ...
        >
            ...
            <ActionButton.Item buttonColor='#3498db' title="Discard" onPress={onPressDiscard}>
                <Ionicons name="times" style={styles.actionButtonIcon} />
            </ActionButton.Item>
            <ActionButton.Item buttonColor='#9b59b6' title="Saved change" onPress={onPressSave}>
